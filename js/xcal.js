...
HTM(a.id, '<thead><tr><td colspan=3 class="cal-m"></td><td colspan=2 class="cal-y"></td><td class="cal-l" title="\'+lang[a.lang].pre+\'">‹</td><td class="cal-r" title="'+lang[a.lang].nex+'">›</td></tr><tr><td>'+lang[a.lang].w+'</td></tr></thead>');
